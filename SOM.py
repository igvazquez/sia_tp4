...
class SOM(object):
    ...
    def distance_map(self):
        um = np.zeros((self._weights.shape[0], self._weights.shape[1], 8))
...
print(winner_coordinates[0][25])
print(winner_coordinates[1][25])

print(winner_coordinates[0][16])
print(winner_coordinates[1][16])

print(winner_coordinates[0][18])
print(winner_coordinates[1][18])
